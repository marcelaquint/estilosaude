...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Comentar', 'kelly' ), __( '1 comentário', 'kelly' ), __( '% Comentários', 'kelly' ) ); ?></span>
		<?php endif; ?>

		<?php edit_post_link( __( 'Editar', 'kelly' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-meta -->
</article><!-- #post-## -->
